...
<body class="antialiased bg-gradient-to-br from-gray-50 to-green-50/30">
    <div class="min-h-screen flex flex-col justify-center items-center p-6">
        ...
        <div class="max-w-md w-full bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-10 md:p-12 border border-white">
            ...
            {{-- TAMBAHAN: Pesan Error Akun Pending (Dari Middleware) --}}
            @if (session('error'))
                <div class="mb-6 p-4 bg-red-50 rounded-2xl border border-red-100 font-bold text-sm text-red-600 text-center flex items-center justify-center gap-2 italic">
